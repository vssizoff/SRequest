...
export function getRequest(url, options = defaultCfg) {
...
export function postRequest(url, body, options = defaultCfg) {
    let {onSuccess, onError, query, outputType, headers} = configValidator(defaultCfg, options);
...
export function formDataRequest(url, body, options = defaultCfg) {
    // console.log(body);
...
export async function getRequestSync(url, options = defaultCfg) {
...
export async function postRequestSync(url, body, options = defaultCfg) {
    return new Promise((resolve, reject) => {
...
export async function formDataRequestSync(url, body, options = defaultCfg) {
    return new Promise((resolve, reject) => {
